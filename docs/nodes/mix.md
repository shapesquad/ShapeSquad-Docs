...
<img src="/mix_node.png" alt="Mix node" style=" border-radius: 6px; margin: 16px 0;" />
...
<img src="/mix_parameters.png" alt="Mix node parameters" style=" border-radius: 6px; margin: 16px 0;" />
...
* **Height Offset** — offsets the layer up or down in height. This is essentially the same as using a *Transform* node with *Height Offset*. For example, if you have pavement stones in sand, you can move the stones up and down inside sand.

<img src="/mix_height_offset_animation.webp" alt="Height Offset animation" style=" border-radius: 6px; margin: 16px 0;" />
...
* **Cut at This Layer** — the selected layer is used as the uppermost layer. Anything above it is cut, and only the layers below it remain. For example, you can use it to cut a cone into a flatter shape using another simple PBR material made with the *Channels* node.
